...
macro (ARTS_TEST_RUN_PYFILE TESTNAME PYFILE)
  ...
  set_tests_properties(
    ${TESTNAME_LONG} PROPERTIES
    ENVIRONMENT "${ASAN_PRELOAD_ENV}PYTHONPATH=${ARTS_BINARY_DIR}/python/src;ARTS_HEADLESS=1;ARTS_XML_DATA_DIR=${ARTS_XML_DATA_DIR};ARTS_CAT_DATA_DIR=${ARTS_CAT_DATA_DIR};ARTS_DATA_PATH=${CMAKE_CURRENT_SOURCE_DIR}/${CFILESUBDIR}"
...
macro (COLLECT_TEST_SUBDIR SUBDIR)
  ...
  foreach(PYFILE ${PYFILES})
    ...
    if (NOT ENABLE_TMATRIX AND PYFILE MATCHES "^(core/tmatrix/|core/scat/mc_general_arts2[.]py$)")
      set(SKIPFILE 1)
    endif()
    if (NOT SKIPFILE)
