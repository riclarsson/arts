...
void RetrievalInit(JacobianTargets&                            jac_targets,
  ...
  model_state_covmatInit(model_state_covmat);
  jac_targetsInit(jac_targets);
  covmat_diagonal_blocks.clear();
}
...
void RetrievalAddSubsurface(JacobianTargets&                            jac_targets,
  ...
  covmat_diagonal_blocks[JacobianTargetType{jac_targets.subsurf.back().type}] = {.first = matrix, .second = inverse};
}
...
void RetrievalAddSpeciesIsotopologueRatio(JacobianTargets&                            jac_targets,
                                          JacobianTargetsDiagonalCovarianceMatrixMap& covmat_diagonal_blocks,
...
void RetrievalAddOverlappingMagneticField(JacobianTargets&                            jac_targets,
                                          JacobianTargetsDiagonalCovarianceMatrixMap& covmat_diagonal_blocks,
                                          const BlockMatrix&                          matrix,
                                          const BlockMatrix&                          inverse) {
  ARTS_TIME_REPORT
  ...
  covmat_diagonal_blocks[JacobianTargetType{jac_targets.atm[N - 2].type}] = {.first = matrix, .second = inverse};

  covmat_diagonal_blocks[JacobianTargetType{jac_targets.atm[N - 1].type}] = {.first = matrix, .second = inverse};
}

void RetrievalAddOverlappingWindField(JacobianTargets&                            jac_targets,
                                      JacobianTargetsDiagonalCovarianceMatrixMap& covmat_diagonal_blocks,
                                      const BlockMatrix&                          matrix,
                                      const BlockMatrix&                          inverse) {
  ARTS_TIME_REPORT
...
void RetrievalAddSensorFrequencyPolyOffset(JacobianTargets&                            jac_targets,
                                           JacobianTargetsDiagonalCovarianceMatrixMap& covmat_diagonal_blocks,
  ...
  covmat_diagonal_blocks[keyk] = {.first = matrix, .second = inverse};
}
