...
extern "C" void zgetri_(
    int *n, std::complex<double> *A, int *lda, int *ipiv, std::complex<double> *work, int *lwork, int *info);
...
*/
extern "C" void ilaenv_(int *ispec, char *name, char *opts, int *n1, int *n2, int *n3, int *n4);
